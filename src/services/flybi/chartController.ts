...
/** getChartDetailById GET /api/chart/chartDetail */
export async function getChartDetailByIdUsingGET(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getChartDetailByIdUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseListMapStringObject_>('/api/chart/chartDetail', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** genChartAiAsyncRetry POST /api/chart/gen/async/asyn/retry */
export async function genChartAiAsyncRetryUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartAiAsyncRetryUsingPOSTParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBIResponse_>('/api/chart/gen/async/asyn/retry', {
    method: 'POST',
    params: {
      ...params,
    },
